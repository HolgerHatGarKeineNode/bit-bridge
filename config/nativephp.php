...
return [
     ...
     */
    'app_id' => env('NATIVEPHP_APP_ID', 'space.einundzwanzig.bitbridge'),
     ...
     */
    'author' => env('NATIVEPHP_APP_AUTHOR', 'Einundzwanzig'),
    ...
    'updater' => [
        ...
        'providers' => [
            ...
            'github' => [
                'driver' => 'github',
                'repo' => env('GITHUB_REPO', 'bit-bridge'),
                'owner' => env('GITHUB_OWNER', 'HolgerHatGarKeineNode'),
